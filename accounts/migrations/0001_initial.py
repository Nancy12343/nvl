...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_account', (
            ...
            ('last_edit', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('point', self.gf('django.db.models.fields.IntegerField')(default=10)),
    ...
    models = {
        u'accounts.account': {
            ...
            'last_edit': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'point': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
